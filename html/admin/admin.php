...
$sql = array('name'=>$name, 'weight'=>$weight, 'category'=>$category, 'price_factor'=>$pricefactor, 'description'=>$description, 'image'=>$image);
...
$sql = array('name'=>$tname, 'd_name'=>$d_name, 'd_contact'=>$d_number, 'price_factor'=>$tpricefactor, 'capacity'=>$tcapacity, 'description'=>$tdescription, 'image'=>$timage);
...
$sql = array('name'=>$sname, 'contact'=>$scontact, 'rating'=>$rating, 'description'=>$sdescription, 'image'=>$simage);
