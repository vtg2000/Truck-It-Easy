...
<body style='background-image: linear-gradient(to right, #780206,#061161);'>
    ...
    <div>
        ...
        <form action="validate.php" id="Myform" method='post'>
            <div
                style='display:flex; color:white; flex-direction: column; margin-left: 40vw; background-image:linear-gradient( #9D50BB, #6E48AA); margin-right:40vw; padding: 2vw; border-radius: 20px'>
                ...
                <br>
                <p style='font-size:12px'>Don't have an account? <a href='register.html'>Register!</a></p>
